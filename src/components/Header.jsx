  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
          ...
          >
            {navigation.map((item) => (
              <a
                ...
                } px-6 py-6 md:px-8 md:py-8 lg:-mr-0.25rem lg:text-xs lg:font-semibold ${
        ...
        <a
          href="#signup"
          className="button hidden mr-8 text-n-1/50 transitons-colors
        ...
        <Button className="hidden lg:flex " href="#login">
          Sign In
            ...
            <Button className="ml-auto lg:hidden" px="px-4" onClick={toggleNavigation}>
